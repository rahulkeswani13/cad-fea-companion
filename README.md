...
**80 behavior evals + 307 unit/integration tests + 63 browser checks gate every push — at zero API cost** (LLM-backed paths fall back to deterministic routing in CI; the rubric judge runs locally via `EVAL_JUDGE=1`).
